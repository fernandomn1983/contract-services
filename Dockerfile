...
ENTRYPOINT ["java", "-Dspring.profiles.active=local", "-Dspring.datasource.url=jdbc:postgresql://postgres-contract-services:5432/contract_services", "-jar", "/app/app.jar"]